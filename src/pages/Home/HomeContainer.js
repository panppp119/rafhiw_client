...
const mapDispatchToProps = {
  loadCategories: options => fetchCategories(categorySchema, options),
  // loadProducts: options => fetchProducts(productSchema, options),
  // loadEvents: options => fetchEvents(eventSchema, options)
};
